...
class Robot(object):
    ...
    def __init__(self, maze, alpha=0.5, gamma=0.9, epsilon0=0.1):
    ...
    def update_parameter(self):
        """
        Some of the parameters of the q learning robot can be altered,
    ...
    def sense_state(self):
        ...
        # state = self.maze.robot_img
        return self.maze.robot['loc']
